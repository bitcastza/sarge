...
class PreferenceDialog(QtWidgets.QDialog):
    ...
    def select_directory(self):
        directory = QFileDialog.getExistingDirectory(
            self.browse_button, "Open directory", self.directory_path.text()
        )
    ...
    def save_changes(self):
        ...
        sarge_settings.sarge_player_channel = channel_value[
            self.channels_field.currentText()
        ]
        sarge_settings.music_directory = self.directory_path.text()
        sarge_settings.sarge_files = [
